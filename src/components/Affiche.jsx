...
import lequipe from "../assets/logos/lequipe.png"
...
import velodrome from "../assets/stades/velodrome.jpg"
import louisII from "../assets/stades/louisll.jpeg"
import bollaert from "../assets/stades/bollaert.jpg"
import bernabeu from "../assets/stades/bernabeu.webp"
...
useEffect(() => {
  ...
  leagues: {
    ...
    61: {               // Ligue 1 (cas particuliers)
      81: velodrome,    // Olympique de Marseille (Stade Vélodrome)
      85: parc,         // Paris Saint-Germain (Parc des Princes)
      91: louisII,
      116: bollaert,
      default: grass    // Autres clubs de Ligue 1
    },
    140: {
        541: bernabeu,
        default: liga
...
const backgroundSource =
  imageBackgrounds.leagues[league]?.[homeTeam] ??
  imageBackgrounds.leagues[league]?.default ??
...
{match.league.id === 48 || match.league.id === 143 || match.league.id === 307 || match.league.id === 61 || match.league.id === 62 || match.league.id === 135 || match.league.id === 2 || match.league.id === 140 || match.league.id === 78 || match.league.id === 39 || match.league.id === 15 || match.league.id === 5 || match.league.id === 6 ? <View style={{flexDirection: "row", alignItems: "center", justifyContent: "center"}}><Text style={{fontFamily: "Kanitus"}}>Match diffusé sur</Text><Image source={match.league.id === 61 ? ligue1plus : match.league.id === 135 || match.league.id === 15 ? dazn : match.league.id === 2 || match.league.id === 39 || match.league.id === 307 ? canal : match.league.id === 140 || match.league.id === 62 || match.league.id === 78 || match.league.id || match.league.id === 48 === 6 ? bein : match.league.id === 5 ? tf1 : match.league.id === 143 ? lequipe : null} style={match.league.id === 61 ? {height: 25, width: 40, objectFit: "contain", marginLeft: 2}: match.league.id === 140 || match.league.id === 6 || match.league.id === 48 || match.league.id === 78 || match.league.id === 143  ? {height: 25, width: 65, objectFit: "contain", marginLeft: 5} : match.league.id === 39 || match.league.id === 2 ? {height: 25, width: 50, objectFit: "contain", marginLeft: 2} : {height: 25, width: 40, objectFit: "contain", marginLeft: 2} }/>{match.fixture.id === 1374812 ? <View style={{flexDirection: "row", alignItems: "center"}}><Text style={{fontFamily: "Kanitus"}}>et</Text><Image source={m6} style={{height: 20, objectFit: "contain", width: 40}} /></View> : match.fixture.id === 1399365 ? <View style={{flexDirection: "row", alignItems: "center"}}><Text style={{fontFamily: "Kanitus"}}>et</Text><Image source={tf1} style={{height: 20, objectFit: "contain", width: 40, marginLeft: 8}} /></View> : null}</View> : null}
