...
import timber from "../assets/portraits/timber.png"
import zinchenko from "../assets/portraits/zinchenko.png"
import white from "../assets/portraits/white.png"
import gabriel from "../assets/portraits/gabriel.png"
...
function Squad({ squad }) {
    ...
    return (
        ...
        <View style={styles.poste}>
          ...
          <Image source={ player.id === 162453 ? chevalier : player.id === 280 ? alisson : player.id === 1622 ? donarumma : player.id === 2068 ? safonov : { uri: player.photo }} style={styles.photo} />
