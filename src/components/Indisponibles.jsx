...
console.log(injuries)
    ...
    return (
        <View style={styles.bloc}>
            ...
            <Text style={{ fontFamily: "Kanitt", fontSize: 18, marginBottom: 10 }}>{t("incertain")}</Text>
             <View style={{ flexDirection: "row", backgroundColor: "rgb(203, 203, 203)", paddingBlock: 10, borderRadius: 15, marginHorizontal: 1 }}>
                                    ...
                                    element.player.reason.indexOf("njur") !== -1 ?
                                        <View style={{ flexDirection: "row", alignItems: "baseline", gap: 5 }}>
                                            ...
                                            element.player.reason === "Surgery" ? <View style={{ flexDirection: "row", gap: 5, alignItems: "center" }}>
                                                ...
                                                <Image source={fracture} style={styles.icone} /><Text style={{ fontFamily: "Kanito", fontSize: 8 }}>{t("fractureCheville")}</Text>
                                            </View> : element.player.reason === "Broken Leg" ? <View style={{ flexDirection: "row", gap: 2, alignItems: "center" }}>
                                                <Image source={jambe} style={styles.icone} /><Text style={{ fontFamily: "Kanito", fontSize: 9 }}>{t("jambeCassee")}</Text>
            ...
            <Text style={{ fontFamily: "Kanitt", fontSize: 18, marginBlock: 10 }}>{t("forfait")}</Text>
                                ...
                                {element.player.reason === null ? null :
                                    element.player.reason === "Yellow Cards" ?
                                        <View style={{ flexDirection: "row", alignItems: "center" }}>
                                            <Text style={{ fontFamily: "Kanito", fontSize: 8 }}>{t("jaune")}</Text> <Image source={yellow} style={styles.icone} />
                                        </View> :
                                        element.player.reason === "Red Card" || element.player.reason === "Red card Suspended" ?
                                            <View style={{ flexDirection: "row", alignItems: "center" }}>
                                                <Image source={redcard} style={styles.icone} /> <Text style={{ fontFamily: "Kanito", fontSize: 9 }}>{t("rouge")}</Text>
                                            </View> :
                                            element.player.reason.indexOf("njur") !== -1 ?
                                                element.player.reason === "Shoulder Injury" || element.player.reason === "Shoulder injury" ?
                                                    ...
                                                    </View> : element.player.reason === "Knee Problems" || element.player.reason === "Jumpers knee" ? <View style={{ flexDirection: "row", gap: 5, alignItems: "baseline" }}>
                                                        <Image source={injury} style={[styles.icone, { position: "relative", top: 3 }]} /><Text style={{ fontFamily: "Kanito", fontSize: 9 }}>{t("genou")}</Text>
                                                    ...
                                                    <View style={{ flexDirection: "row", gap: 5, alignItems: "center" }}>
                                                        <Image source={malade} style={[styles.icone, { height: 22 }]} /><Text style={{ fontFamily: "Kanito", fontSize: 9 }}>{t("malade")}</Text>
                                                    </View>
                                                    : element.player.reason.indexOf("urgery") != -1 ? <View style={{ flexDirection: "row", gap: 5, alignItems: "center" }}>
                                                        ...
                                                        <Image source={jambe} style={styles.icone} /><Text style={{ fontFamily: "Kanito", fontSize: 9 }}>{t("jambeCassee")}</Text>
                                                    </View> : element.player.reason.indexOf("ruciate ligament") != -1 || element.player.reason.indexOf("ruciate Ligament") != -1 ? <View style={{ flexDirection: "row", gap: 2, alignItems: "center" }}>
                                                        ...
                                                        <Text style={{ fontFamily: "Kanito", fontSize: 9 }}>{t("muscle")}</Text>
                                                    </View> : element.player.reason === "Calf Problems" ? <View style={{ flexDirection: "row", gap: 2, alignItems: "baseline" }}>
                                                        <Image source={injury} style={[styles.icone, {position: "relative", top: 3}]} /><Text style={{ fontFamily: "Kanito", fontSize: 9 }}>{t("mollet")}</Text>
                                                    </View> : element.player.reason === "Adductor problems" ? <View style={{ flexDirection: "row", gap: 5, alignItems: "baseline" }}>
                                                        <Image source={injury} style={[styles.icone, { position: "relative", top: 3 }]} /><Text style={{ fontFamily: "Kanito", fontSize: 9 }}>Adducteurs</Text>
                                            ...
                                            </View> : element.player.reason.indexOf("cromioclavicular joint disloc") != -1 ?
                                                    <View style={{ flexDirection: "row", alignItems: "center", gap: 1 }}>
                                                        <Image source={epaule} style={[styles.icone, { width: 19, height: 19 }]} />
                                                        <Text style={{ fontFamily: "Kanito", fontSize: 9 }}>Luxation clavicule</Text>
                                                    </View> : element.player.reason === "Back bruise" ? <View style={{ flexDirection: "row", gap: 3, alignItems: "baseline" }}>
                                                <Image source={injury} style={[styles.icone, { position: "relative", top: 2 }]} /><Text style={{ fontFamily: "Kanito", fontSize: 10 }}>{t("dos")}</Text>
                                            </View> : element.player.reason === "Inflammation" ? <View style={{ flexDirection: "row", gap: 2, alignItems: "baseline" }}>
                                                <Image source={injury} style={[styles.icone, { position: "relative", top: 2 }]} /><Text style={{ fontFamily: "Kanito", fontSize: 9.5 }}>Inflammation</Text>
                                            </View> : element.player.reason === "Heel pain" ? <View style={{ flexDirection: "row", gap: 3, alignItems: "baseline" }}>
                                                <Image source={injury} style={[styles.icone, { position: "relative", top: 2 }]} /><Text style={{ fontFamily: "Kanito", fontSize: 10 }}>Talon</Text>
                                            </View> : element.player.reason === "Wound" ? <View style={{ flexDirection: "row", gap: 3, alignItems: "baseline" }}>
                                            ...
                                            element.player.reason.indexOf("njur") !== -1 ?
                                                element.player.reason === "Shoulder Injury" || element.player.reason === "Shoulder injury" ?
                                                    ...
                                                    : element.player.reason.indexOf("urgery") != -1 ? <View style={{ flexDirection: "row", gap: 5, alignItems: "center" }}>
                                                        ...
                                                        <Image source={fracture} style={styles.icone} /><Text style={{ fontFamily: "Kanito", fontSize: 8.5 }}>{t("fractureCheville")}</Text>
                                                    </View> : element.player.reason === "Broken Leg" || element.player.reason === "Broken leg" ? <View style={{ flexDirection: "row", gap: 2, alignItems: "center" }}>
                                                        <Image source={jambe} style={styles.icone} /><Text style={{ fontFamily: "Kanito", fontSize: 9 }}>{t("jambeCassee")}</Text>
                                                    </View> : element.player.reason.indexOf("ruciate ligament") != -1 || element.player.reason.indexOf("ruciate Ligament") != -1 ? <View style={{ flexDirection: "row", gap: 2, alignItems: "center" }}>
                                                        <Image source={ligaments} style={styles.icone} /><Text style={{ fontFamily: "Kanito", fontSize: 9 }}>Ligaments croisés</Text>
