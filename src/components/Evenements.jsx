            ...
            return (
              <View style={{ flexDirection: "row", alignItems: "center", gap: 5 }}>
                ...
                <View style={isHomeTeam ? styles.domicile : styles.exterieur} key={element.id}>
                  ...
                  <View style={{ width: "100%", justifyContent: "center", height: 95 }}>
                    {element.type === "Goal" && element.detail != "Missed Penalty" ?
                      <View style={{ flexDirection: "row", borderTopLeftRadius: 10, borderTopRightRadius: 10, paddingBlock: 3, paddingInline: 15, justifyContent: "space-between", backgroundColor: element.type === "Goal" && element.detail != "Missed Penalty" ? "black" : null }}>
                      ...
                      <View style={{ flexDirection: "row", alignItems: "center" }}>
                        ...
                        {element.type === "subst" && (
                          <View style={styles.substitutionContainer}>
                            <TouchableOpacity onPress={() => navigation.navigate('FicheJoueur', { id: element.assist.id,  team: element.team.id })} style={{ alignItems: "center" }}>
