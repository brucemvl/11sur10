                    ...
                    {element.type === "Goal" && (
                      element.detail === "Missed Penalty" ? <View style={styles.goalContainer}>
                        ...
                        <View style={styles.goalContainer}>
                          <Text style={styles.goalText}>
                            ⚽ {element.player.name} {element.detail === "Penalty" ? <Text style={{fontFamily: "Kanitalic"}}>(Pen.)</Text> : element.detail === "Own Goal" ? <Text style={{fontFamily: "Kanitalic", color: "red"}}>(csc)</Text> : ""}
                          </Text>
                          {element.assist?.name && (
